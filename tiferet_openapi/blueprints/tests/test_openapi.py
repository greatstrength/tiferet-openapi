...
# ** tester: test_build_openapi_session_context
@use_tester(
    type='generic',
    target_cls=build_openapi_session_context,
)
class TestBuildOpenApiSessionContext:
    '''
    Bound generic tester for build_openapi_session_context.
    '''
...
class TestGetRouteHandler:
    ...
    def test_get_route_handler_resolves_event_via_get_dependency(self) -> None:
        '''
...
# ** tester: test_create_openapi_request_context
@use_tester(
    type='generic',
    target_cls=create_openapi_request_context,
)
class TestCreateOpenApiRequestContext:
    '''
    Bound generic tester for create_openapi_request_context.
    '''

    # * test: create_openapi_request_context_returns_openapi_request_context
    def test_create_openapi_request_context_returns_openapi_request_context(self) -> None:
        '''
